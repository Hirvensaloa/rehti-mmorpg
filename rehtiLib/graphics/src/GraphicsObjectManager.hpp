...
class GraphicsObjectManager
{
  public:
     ...
     */
    bool addGameObject(int objectId, const std::vector<Vertex>& vertices, const std::vector<uint32_t>& indices,
                       ImageData& texture, glm::mat4 transformation, VkSampler imgSampler);
     ...
     */
    bool addTestObject(int id, const std::vector<SimpleVertex>& vertices, const std::vector<uint32_t>& indices,
     ...
     * @return boolean indicating success
     */
    bool addArea(const std::vector<Vertex>& vertices, const std::vector<uint32_t>& indices,
                 std::array<ImageData, 6> textures, VkSampler texSampler);
     ...
     * @param dstLayout
     */
    void transitionDepthImageLayout(AllocatedImage depthImage, VkFormat depthFormat, VkImageLayout srcLayout,
  ...
  private:
     ...
     */
    bool getPipelineAndAccessFlags(VkImageLayout srcLayout, VkImageLayout dstLayout,
