...
const std::vector<VkDescriptorPoolSize> STANDARD_POOL_SIZES(
	{
...
public:
	...
	/// <param name="poolSizes">List of limits on individual descriptors that can be allocated from this pool. For example 2 uniform buffers or 3 images.</param>
	/// <returns></returns>
	...
	/// </summary>
	/// <returns></returns>
	VkDevice getDevice() const { return logDeviceM; }
private:
	/// <summary>
